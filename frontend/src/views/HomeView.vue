      ...
      <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
        ...
        <nav id="navbar" class="navbar">
          <ul>
            ...
            <li class="dropdown"><a href="#"><span>go</span> <i
                  class="bi bi-chevron-down dropdown-indicator"></i></a>
              <ul>
                <li> <router-link tag="button" class="btn" to="dashboard"> Subjects </router-link> </li>
                <li> <router-link tag="button" class="btn" to="links"> Links </router-link> </li>
              </ul>
            </li>
          </ul>
        </nav><!-- .navbar -->
